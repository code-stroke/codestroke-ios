...
open class DesignableTextView : UITextView {
    ...
    required public init?(coder aDecoder: NSCoder) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(DesignableTextView.refreshPlaceholder), name: NSNotification.Name.UITextViewTextDidChange, object: self)
    }
